...
const COLUMNS: { title: string; links: [string, string][] }[] = [
  {
    ...
    links: [
      ...
      ["DSCR rental purchase (full funnel)", "/loans/dscr-rental-purchase"],
  ...
  },
  {
    ...
    links: [
      ...
      ["Technical case study", "/case-studies/dscr-lending-platform"],
  ...
  },
  {
    title: "Growth",
    links: [
      ["SEO strategy", "/growth/seo"],
      ["AI search strategy", "/growth/ai-search"],
      ["Paid search", "/growth/paid-search"],
